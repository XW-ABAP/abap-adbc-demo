*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_ZFIR057AT1
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_ZFIR057AT1      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_ZFIR057AT1'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_ZFIR057AT1_EXTRACT
TOTAL = ZMV_ZFIR057AT1_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_ZFIR057AT1'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_ZFIR057AT1-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_ZFIR057AT1_EXTRACT
TOTAL = ZMV_ZFIR057AT1_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_ZFIR057AT1-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_ZFIR057AT1'
...
TOTAL = ZMV_ZFIR057AT1_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_ZFIR057AT1-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_ZFIR057AT1-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_ZFIR057AT1'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_ZFIR057AT1-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_ZFIR057AT1_EXTRACT
TOTAL = ZMV_ZFIR057AT1_TOTAL
